...
/**
 * Egg Economy Salesforce Anti-Corruption Layer
 *
 * Demonstrates MeshQL as an anti-corruption layer over a Salesforce-style legacy database:
 * 1. Salesforce PostgreSQL data is captured by Debezium CDC
 * 2. Changes flow through Kafka topics (10 topics, one per legacy table)
 ...
 * 5. Projections are updated inline (no MongoDB CDC needed)
 *
 * Single MongoDB instance, 13 graphlettes/restlettes, 5-phase processor startup.
 */
public class Main {
    private static final Logger logger = LoggerFactory.getLogger(Main.class);

    public static void main(String[] args) throws Exception {
        logger.info("Starting Egg Economy Salesforce Anti-Corruption Layer");

        String mongoUri = getEnv("MONGO_URI", "mongodb://localhost:27017");
        String prefix = getEnv("PREFIX", "egg_economy_salesforce");
        ...
        // Single MongoDB for all entities
        ...
        logger.info("Salesforce legacy processor started");

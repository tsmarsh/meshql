...
# Egg Economy seed data generator
# Generates actors, events, and verifies projection materialization.
# Produces enough data for good frontend screenshots.
#
...
echo "Waiting 15 seconds for CDC pipeline to process events..."
sleep 15

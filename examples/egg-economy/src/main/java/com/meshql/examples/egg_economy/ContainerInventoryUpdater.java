...
/**
 * Updates ContainerInventory projections in response to:
 * - StorageDeposit: increment current_eggs, total_deposits
 * - StorageWithdrawal: decrement current_eggs, increment total_withdrawals
 * - ContainerTransfer: decrement source, increment dest
 * - ConsumptionReport: decrement current_eggs, increment total_consumed
 */
public class ContainerInventoryUpdater extends ProjectionUpdater {
    ...
    public void onConsumption(JsonNode event) {
        ...
        // total_consumed is tracked separately
    ...
    private void updateContainer(String containerId, int eggsDelta, int depositsDelta,
        ...
        // utilization_pct would require knowing container capacity — left for query-time

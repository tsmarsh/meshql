...
/**
 * Updates FarmOutput projections in response to LayReport events.
 * Increments totals and recalculates per-hen averages.
 */
public class FarmOutputUpdater extends ProjectionUpdater {
    ...
    public void onLayReport(JsonNode event) {
        ...
        if (meshqlId == null) {
            // Look up farm_type from the farm entity

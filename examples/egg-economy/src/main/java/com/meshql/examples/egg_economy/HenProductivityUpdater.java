...
/**
 * Updates HenProductivity projections in response to LayReport events.
 * Increments egg totals and recalculates averages.
 */
public class HenProductivityUpdater extends ProjectionUpdater {
    ...
    public void onLayReport(JsonNode event) {
        ...
        // Simple running quality rate: weighted average
        ...
        updated.put("avg_per_week", (double) eggsWeek); // Simplified: resets each week in production
